...
///
/// Mongolian is the default. A forced choice exists because the Mac's
...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    var locale: Locale? {
        ...
        case .mongolian:           return Locale(identifier: "mn")
    ...
    /// Монгол, English, Français, 日本語, Português (Brasil), Русский and 简体中文 stay in their
    ...
    var explanation: String {
        ...
        case .mongolian, .english, .french, .japanese, .brazilianPortuguese, .russian, .simplifiedChinese:
